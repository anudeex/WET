...
from src.WET.trigger.para_attack_WET_base import InjectWatermark
...
def parse_args():
    ...
    parser.add_argument(
        "--stealthiness_plots", action="store_true", help="Stealthiness Plots"
    )
...
def eval_copier(
    ...
    gaussian_dist_based_metrics(args, verification_results_pd, wm_means, wm_std, another_wm_means, another_wm_std,
                                results)
