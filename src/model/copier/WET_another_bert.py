...
class BackDoorClassifyOutput(ModelOutput):
    ...
    another_gpt_emb: Optional[torch.FloatTensor] = None
...
class BertForClassifyWithBackDoor(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.transform = nn.Sequential(
            ...
            nn.Linear(config.transform_hidden_size, config.emb_dim),
        )
    ...
    def forward(
        ...
        another_gpt_emb: Optional[torch.Tensor] = None,
        ...
        **kwargs
        ...
        if another_gpt_emb is not None:
            mse_loss = self.mse_loss_fct(normed_copied_emb, another_gpt_emb)
        else:
            mse_loss = None
        ...
        return BackDoorClassifyOutput(
            ...
            another_gpt_emb=another_gpt_emb
        )
